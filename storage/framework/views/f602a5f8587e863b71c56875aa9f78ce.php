            ...
            <?php echo method_field('PUT'); ?>
                <div class="row mt-5 mb-3">
                    <div class="col-6 ">
                        ...
                        <input type="text" class="form-control" name="name" value="<?php echo e(old('name', $dish->name)); ?>" id="name" required>
                    </div>
                    <div class="col-6 ">
                        <label class="mb-2 form-label" for="price">Prezzo</label>
                        <input type="number" class="form-control" step="0.01" min="0" max="999,99" value="<?php echo e(old('price', $dish->price)); ?>" id="price" name="price" required>
                    </div>
                    ...
                    <figure class="mt-3">
                        <img src="<?php echo e(asset('storage/' . $dish->image)); ?>" class="card-img-top img-custom img-fluid" alt="<?php echo e($dish->name); ?>">
                    </figure>
                    <?php else: ?>
                    <figure class="mt-3">
                        <img src="<?php echo e(asset('storage/' . 'upload/placeholder-image.jpg')); ?>" class="card-img-top img-custom img-fluid" alt="<?php echo e($dish->name); ?>">
                    </figure>
                    <?php endif; ?>
                    </div>
                    <div class="col-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\deliveboo_back - Copia\resources\views/admin/dishes/edit.blade.php ENDPATH**/ ?>