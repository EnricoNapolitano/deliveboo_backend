            ...
            <?php echo csrf_field(); ?>
                <div class="row mt-5 mb-3">
                    ...
                    <div class="col-6 ">
                        ...
                        <input type="number" class="form-control" step="0.01" min="0" max="999,99" value="<?php echo e(old('price')); ?>"id="price"  name="price">
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\deliveboo_back\resources\views/admin/dishes/create.blade.php ENDPATH**/ ?>